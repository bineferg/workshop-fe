  ...
  render() {
    ...
    <main>
      <article className="bg-white">
        <div className="vh-75 cover bg-center mt8 mb2" style={{backgroundImage: `url(${bgimage})`}}></div>
        <div className="ph4 ph5-m ph6-l">
          <div className="pv5 f4 f2-ns measure center">
            ...
            <p className="db lh-copy black-70 serif fw1 mv0 f4 f3-m f2-l measure avenir">
...
for on going shows, talks and public performances.
        ...
        <div className='fl w-25 pr3'>
          <div className="pv6 cover bg-center" style={{backgroundImage: `url(${space})`}}></div>
        </div>
        <div className='fl w-25 pr3 '>
          <div className="pv6 cover bg-center" style={{backgroundImage: `url(${gallery})`}}></div>
        </div>
        <div className='fl w-25 pr3 '>
          <div className="pv6 cover bg-center" style={{backgroundImage: `url(${stock})`}}></div>
        </div>
      </div>
      <div className="measure f3 mt3 center mv5 black-70">
