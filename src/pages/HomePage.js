    ...
    <main>
      <article className="bg-white">
        <div className="vh-75 cover bg-center mt8 mb4" style={{backgroundImage: `url(${bgimage})`}}></div>
          <div className="pv5 f4 f2-ns measure center ph4 ph5-m ph6-l">
...
for on going shows, talks and public performances.
      ...
      <div className="measure f3 center pv6 ph4 ph5-m ph6-l black-70">
      ...
      <div className="measure f3 mt3 center ph4 ph5-m ph6-l pv6 black-70">
      ...
      <div className="measure f3 mt3 ph4 ph5-m ph6-l center pv6 black-70">
